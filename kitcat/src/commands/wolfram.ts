 ...
 */
function createApiParams(baseUrl: string, input: any, output = 'string') {
 ...
 * })
 */
function fetchResults(params: any) {
 ...
 * })
 */
function formatResults(params: any) {
...
class WolframAlphaAPI {
    ...
    getSimple(input: any) {
        ...
        return createApiParams(baseUrl, input, 'image').then(fetchResults).then(formatResults);
    }
    ...
    getShort(input: any) {
        ...
        return createApiParams(baseUrl, input).then(fetchResults).then(formatResults);
    }
