...
var games: Record<Snowflake, Game> = {};
    ...
    switch (args[0]) {
      ...
      case 'new':
        if (!args[1]) {
          ...
          newGame(<TextChannel>message.channel, 4);
        } else {
          ...
          else newGame(<TextChannel>message.channel, Number(args[1]));
        }
        break;
      case 'stop':
        updateBoard(<TextChannel>message.channel);
        break;
      default:
