...
const help = new Discord.MessageEmbed()
    ...
    .addField(':arrow_up_down: Random Case', `Changes the casing of the text randomly.\n\`${pfx}case {text}\``)
    .addField(':rainbow: Color Commands', `Run \`${pfx}text {color} {text}\` to change the color of the text.\nColors: \`${colors.join('\`, \`')}\`.`)
    /*
